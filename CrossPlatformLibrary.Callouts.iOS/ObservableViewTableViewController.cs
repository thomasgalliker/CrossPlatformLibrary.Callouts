...
{
    public class CrossPlatformLibrary.CalloutsTableViewController<T> : UITableViewController, INotifyPropertyChanged
    {
        public const string SelectedItemPropertyName = "SelectedItem";

        private CrossPlatformLibrary.Callouts<T> dataSource;
        ...
        /// </summary>
        public CrossPlatformLibrary.Callouts<T> DataSource
        {
            get
            {
        ...
        /// </summary>
        public CrossPlatformLibrary.CalloutsTableViewController()
        ...
        public CrossPlatformLibrary.CalloutsTableViewController(UITableViewStyle tableStyle)
            : base(tableStyle)
        {
            this.Initialize();
        }
        ...
        {
            private readonly CrossPlatformLibrary.CalloutsTableViewController<T2> controller;
            ...
            public ObservableTableSource(CrossPlatformLibrary.CalloutsTableViewController<T2> controller)
            {
